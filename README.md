...
- Move into the repo directory `cd linkedin-connections-email-extractor`
...
- Add the `Connections.csv` file into the `linkedin-connections-email-extractor` directory
